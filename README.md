...
# debian-iso-builder-respin-budgie
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-budgie/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-budgie/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-budgie/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-budgie](https://github.com/samwhelp/debian-iso-builder-respin-budgie)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-budgie.git
```


> change dir to `debian-iso-builder-respin-budgie`

``` sh
cd debian-iso-builder-respin-budgie
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-budgie/dist`
